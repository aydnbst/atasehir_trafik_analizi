...
---
### Çalıştırma
Öncelikle Projenin bulunduğu klasör içerisinde terminalden dosyamızı çalıştırıyoruz
  python emisyon.py

Ardından ikinci bir terminal içerisinde 
...
└── requirements.txt      # Sunucu Bağımlılık Matris
